...
if("TRUE" STREQUAL "TRUE")
  set(svo_ros_SOURCE_PREFIX /home/mohammad/svo/src/rpg_svo_pro_open/svo_ros)
  set(svo_ros_DEVEL_PREFIX /home/mohammad/svo/devel/.private/svo_ros)
  set(svo_ros_INSTALL_PREFIX "")
  set(svo_ros_PREFIX ${svo_ros_DEVEL_PREFIX})
else()
  set(svo_ros_SOURCE_PREFIX "")
  set(svo_ros_DEVEL_PREFIX "")
  set(svo_ros_INSTALL_PREFIX /home/mohammad/svo/install)
...
if(NOT "/home/mohammad/svo/src/rpg_svo_pro_open/svo_ros/include " STREQUAL " ")
  set(svo_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/mohammad/svo/src/rpg_svo_pro_open/svo_ros/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'svo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mohammad/svo/src/rpg_svo_pro_open/svo_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mohammad/svo/devel/.private/svo_ros/lib;/home/mohammad/svo/devel/lib;/opt/ros/melodic/lib)
...
set(depends "cmake_modules;cv_bridge;eigen_catkin;eigen_checks;image_transport;nodelet;roscpp;minkindr;nav_msgs;pcl_ros;rpg_common;sensor_msgs;std_msgs;svo;svo_cmake;svo_common;svo_msgs;svo_tracker;svo_ceres_backend;svo_online_loopclosing;svo_global_map;tf;vikit_common;vikit_ros;visualization_msgs")
